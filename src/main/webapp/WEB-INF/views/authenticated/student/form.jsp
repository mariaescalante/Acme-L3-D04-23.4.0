...
<acme:form>
	...
	<acme:submit test="${_command == 'create'}" code="authenticated.provider.form.button.create" action="/authenticated/student/create"/>
	<acme:submit test="${_command == 'update'}" code="authenticated.provider.form.button.update" action="/authenticated/student/update"/>
</acme:form>
