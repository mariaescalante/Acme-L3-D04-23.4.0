...
<acme:button test="${showCreate && !exceptional}" code="company.session-practicum.list.button.create-exceptional" action="/company/session-practicum/create?masterId=${id}"/>
