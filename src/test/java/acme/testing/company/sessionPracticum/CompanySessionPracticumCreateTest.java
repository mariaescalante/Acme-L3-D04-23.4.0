...
public class CompanySessionPracticumCreateTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/company/sessionPracticum/create-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/company/sessionPracticum/create-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
