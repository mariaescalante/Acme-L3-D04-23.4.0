...
public class CompanySessionPracticumCreateExceptionalTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/company/session-practicum/create-positive-exceptional.csv", encoding = "utf-8", numLinesToSkip = 1)
	public void test100Positive(final int practicumRecordIndex, final int sessionPracticumRecordIndex, final String title, final String abstract$, final String startDate, final String endDate, final String furtherInformationLink, final String correction) {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/company/session-practicum/create-negative-exceptional.csv", encoding = "utf-8", numLinesToSkip = 1)
	public void test200Negative(final int practicumRecordIndex, final int sessionPracticumRecordIndex, final String title, final String abstract$, final String startDate, final String endDate, final String furtherInformationLink) {
