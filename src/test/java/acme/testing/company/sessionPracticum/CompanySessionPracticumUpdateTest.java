...
//	public void test100Positive(final int recordIndex, final int sessionPracticumRecordIndex, final String abstract$, final String startDate, final String endDate, final String title, final String furtherInformationLink, final String correction) {
...
//	public void test200Negative(final int recordIndex, final int sessionPracticumRecordIndex, final String abstract$, final String startDate, final String endDate, final String title, final String furtherInformationLink, final String correction) {
