...
public class CompanySessionPracticumListTest extends TestHarness {
	...
	public void test100Positive(final int practicumRecordIndex, final int sessionPracticumRecordIndex, final String title, final String startDate, final String endDate, final String correction) {
