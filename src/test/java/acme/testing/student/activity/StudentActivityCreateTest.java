...
//		super.checkColumnHasValue(activityRecordIndex, 1, abstract$);
//		super.checkColumnHasValue(activityRecordIndex, 2, indication);
//
...
//	public void test200Negative(final int enrolmentRecordIndex, final String title, final String abstract$, final String indication, final String startDate, final String endDate, final String link) {
//
