...
public class StudentActivityListTest extends TestHarness {
	...
	public void test100Positive(final int enrolmentRecordIndex, final String code, final int activityRecordIndex, final String title, final String abstract$, final String indication) {
