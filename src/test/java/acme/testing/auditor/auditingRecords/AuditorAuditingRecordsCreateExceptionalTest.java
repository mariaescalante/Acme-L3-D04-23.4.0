...
public class AuditorAuditingRecordsCreateExceptionalTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/auditor/auditingRecords/create-exceptional-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	public void test100Positive(final int auditRecordIndex, final int auditingRecordsRecordIndex, final String subject, final String assessment, final String startDate, final String endDate, final String mark, final String link) {
		...
		super.clickOnButton("Create exceptional auditing record");
		...
		super.clickOnSubmit("Create exceptional auditing record");
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/auditor/auditingRecords/create-exceptional-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
